Feature: Search
  ...
  Scenario: Verify the cheapest available hotel is less than $100
    Given I am on hotels landing page
    When I enter 'hotels' in search
    And I select 'Hollywood Beach Hotels, Hollywood, Florida, United States of America' from hotels autosuggestions
    And I click on Search button
    And I hold the mouse to the price button
    And I sort the result 'Price low to high'

  Scenario: Verify the cheapest available hotel is less than 100 dollars
    Given I am on hotels landing page
    When I enter 'york' in search
    And I select 'Lake George, New York, United States of America' from autosuggestions
    And I click on Search button
    ...
    And I verify the lowest price is less than 100 dollars
